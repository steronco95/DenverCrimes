...
public class EventsDao {
	...
	public List<Adiacenza> getAdiacenza(String categoria, Integer mese) {
		...
		try {
			...
			while(res.next()) {
				adiacenza.add(new Adiacenza(res.getString("e1.offense_type_id"),res.getString("e2.offense_type_id"),res.getDouble("peso")));
			}
